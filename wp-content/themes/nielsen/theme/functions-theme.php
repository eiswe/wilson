...
if( ! function_exists('yith_wcan_dropdown_class') ){
	/**
     * Style compatibility 
     *
     * @author Andrea Grillo <andrea.grillo@yithemes.com>
     * @since 2.0
     */
	function yith_wcan_dropdown_class( $class ){
		return $class . ' border';
	}
}
add_filter( 'yith_wcan_dropdown_class', 'yith_wcan_dropdown_class' );

if( !function_exists( 'yit_filter_title_special_characters' ) ) {
    /**
     ...
     * @since 1.0
     */
    function yit_filter_title_special_characters( $chars )
    {
    ...
    add_filter( 'yit_title_special_characters', 'yit_filter_title_special_characters', 99 );
}
