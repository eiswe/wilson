...
return array(
    ...
    array(
        ...
        'style'           => array(
            'selectors'  => 'ul.products li.product .product-wrapper .product-actions-wrapper .product-action-button a,
                             ...
                             .yith-ywraq-add-button .add-request-quote-button.ywraq-link,.yith_ywraq_add_item_response_message,.yith_ywraq_add_item_browse_message',
            'properties' => 'font-size,
                              font-family,
                              font-weight,
                              text-transform,
    ...
    array(
        ...
        'style' => array(
            'normal' => array(
                'selectors'   => 'ul.products li.product .product-wrapper .product-actions-wrapper .product-action-button a,
                                  .yith-ywraq-add-button .add-request-quote-button.ywraq-link,.yith_ywraq_add_item_response_message,.yith_ywraq_add_item_response_message',
                'properties'  => 'color'
            ),
            'hover' => array(
                'selectors'   => 'ul.products li.product .product-wrapper .product-actions-wrapper .product-action-button a:hover,
                                  .yith-ywraq-add-button .add-request-quote-button.ywraq-link:hover,.yith_ywraq_add_item_response_message:hover,.yith_ywraq_add_item_response_message:hover',
                'properties'  => 'color'
            )
        )
    ),
    ...
    array(
        ...
        'style'      => array(
            ...
            'hover' => array(
                ...
                .widget_shopping_cart .widget_shopping_cart_content a.remove:hover, a.yith-ywraq-list-item-info:hover',
                'properties' => 'color'
            )
        )
    ),
